...
import { Users, CheckCircle, XCircle, Edit, Shield, UserX, AlertCircle, Plus, Filter, Trash2 } from "lucide-react";
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Tem certeza que deseja excluir o usuário <strong>{deletingUsuario?.name}</strong>?
